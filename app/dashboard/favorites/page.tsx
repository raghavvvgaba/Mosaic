...
export default function FavoritesPage() {
  ...
  const { deleteDocument, toggleFavorite, updateDocument } = useDocumentMutations();
        ...
        <div className="container mx-auto max-w-6xl">
          {!documents || documents.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 text-center bg-card/50 rounded-xl border border-dashed border-border/60">
              ...
              <h3 className="text-lg font-semibold mb-1">No favorite documents</h3>
              <p className="text-sm text-muted-foreground max-w-xs mx-auto">
                Star documents to have them appear here for quick access.
              </p>
            </div>
          ) : (
